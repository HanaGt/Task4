...
import { useVerifyEmailMutation } from "@/app/api/auth/api/authSlice";
import { AppDispatch , RootState } from "@/app/api/store";

import { useDispatch, useSelector } from "react-redux";

import { setUserData } from "@/app/api/auth/userSlice";
...
const VerifyEmail = () => {
  ...
  return (
    <div className="flex border items-center justify-center  bg-gray-200 h-screen font-epilogue text-base text-[#202430] text-opacity-50">
      <div className="h-custom-card-height w-[500px] rounded-[30px]  bg-white p-10 shadow-lg mb-6">
      {isLoading && (
